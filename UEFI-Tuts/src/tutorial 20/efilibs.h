...
// This is updated for this particular tutorial. However the way I did this was not working,
// so I hacked a work-around. The idea of creating a C-Library in the first place, is no longer
// relevant.
