...
# 9 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/14.1.0/include/stdint.h" 3 4
...
# 426 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/14.1.0/include/stddef.h" 3 4
typedef struct {
  long long __max_align_ll __attribute__((__aligned__(__alignof__(long long))));
  long double __max_align_ld __attribute__((__aligned__(__alignof__(long double))));
# 437 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/14.1.0/include/stddef.h" 3 4
} max_align_t;
...
# 10 "C:/msys64/mingw64/lib/gcc/x86_64-w64-mingw32/14.1.0/include/stdint.h" 2 3 4
# 8 "efi.h" 2
# 98 "efi.h"
...
EFI_STATUS efi_main(EFI_HANDLE IH, EFI_SYSTEM_TABLE *ST)
{
 ...
 SetColor(0x0E);
    Print(L"0x");
    itoa(*(unsigned long int*)&bi.BaseAddress, GOPINFO, 16);
    Print(GOPINFO);
    Print(L"\r\n");
    ...
    SetColor(0x0F);
    Print(L"Width             : ");
    itoa(bi.ScreenWidth, GOPINFO, 10);
    SetColor(0x0E);
    Print(GOPINFO);
    Print(L"\r\n");
    ...
    SetColor(0x0F);
    Print(L"Height            : ");
    itoa(bi.ScreenHeight, GOPINFO, 10);
    SetColor(0x0E);
    Print(GOPINFO);
    Print(L"\r\n");
    ...
    itoa(bi.PixelsPerScanLine, GOPINFO, 10);
    SetColor(0x0E);
    Print(GOPINFO);
 ...
 Print(L": ");
 EFI_TIME Time;
 SystemTable->RuntimeServices->GetTime(&Time, 
# 254 "efimain.c" 3 4
                                             ((void *)0)
# 254 "efimain.c"
                                                 );
 ...
 Print(L" / ");
 SetColor(0x0E);
 itoa(Time.Day, snum, 10);
 Print(snum);
 Print(GetDayExtension(Time.Day));
 SetColor(0x0C);
    Print(L" / ");
 SetColor(0x0E);
 itoa(Time.Year, snum, 10);
 Print(snum);
 Print(L"\r\n\r\n");
 ...
 SetColor(0x0F);
    ...
    itoa(*(unsigned long int*)&bi.LoaderFileSize, GOPINFO, 10);
    SetColor(0x0E);
    Print(GOPINFO);
 SetColor(0x03);
    Print(L" Bytes\r\n\r\n");
